...
function generateSeedData(): Store {
  ...
  const classEn = ['Section A', 'Section B', 'Section C', 'Section D'];
  ...
  for (let g = 0; g < grades.length; g++) {
      ...
      students.push({
        ...
        className: `${gradeEn[g]} - ${pick(classEn)}`,
  ...
  return {
    ...
    borrows,
    'academic-years': [
      { id: 1, label: '2025 / 2026', startDate: '2025-09-01', endDate: '2026-06-30', isCurrent: false },
      { id: 2, label: '2026 / 2027', startDate: '2026-09-01', endDate: '2027-06-30', isCurrent: true },
    ],
    attendance,
    activity,
  };
